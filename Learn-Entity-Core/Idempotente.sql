...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20211210102252_PrimeiraMigracao')
BEGIN
...
BEGIN
    CREATE TABLE [Produtos] (
        [Id] int NOT NULL IDENTITY,
        [CodigoDeBarras] VARCHAR(14) NOT NULL,
...
BEGIN
    ...
    VALUES (N'20211210102252_PrimeiraMigracao', N'5.0.12');
END;
GO
